 ...
 */
public class Almacendevoluciones  implements java.io.Serializable {
    ...
    public Almacendevoluciones() {
    }

	
    public Almacendevoluciones(long id) {
        this.id = id;
    }
    public Almacendevoluciones(long id, Long idVenta, Long idArticulo,String codigoArticulo, String descripcionArticulo,Double precioCompra, Double precioVenta, String tipoBeneficio, Double beneficio, Double conBeneficio, Integer cantidad, Double subtotal) {
       this.id = id;
