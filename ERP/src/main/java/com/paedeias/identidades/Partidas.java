...
public class Partidas  implements java.io.Serializable {
    ...
    public Partidas(long id) {
        this.id = id;
    }
    public Partidas(long id, Long idVenta, Long idArticulo,String codigoArticulo, String descripcionArticulo,Double precioCompra, Double precioVenta, String tipoBeneficio, Double beneficio, Double conBeneficio, Integer cantidad, Double subtotal) {
       this.id = id;
