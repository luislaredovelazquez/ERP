 ...
 */
public class Partidasventaanticipos  implements java.io.Serializable {
    ...
    public Partidasventaanticipos() {
    }

	
    public Partidasventaanticipos(long id) {
        this.id = id;
    }
    public Partidasventaanticipos(long id, Long idVenta, Long idArticulo,String codigoArticulo, String descripcionArticulo,Double precioCompra, Double precioVenta, String tipoBeneficio, Double beneficio, Double conBeneficio, Integer cantidad, Double subtotal) {
       this.id = id;
