...
public class PageableText implements Pageable, Printable {
  ...
  public static String FONTFAMILY = Font.DIALOG;
  ...
  public PageableText(Reader stream, PageFormat format) throws IOException {
    ...
    /** Create a PageableText object for a stream of text and specifies fontsize */
  public PageableText(Reader stream, PageFormat format, int fontsize) throws IOException {
    this.format = format;
  ...
  public int print(Graphics g, PageFormat format, int pagenum) {
    ...
    if (baseline == -1) {
     ...
     paper.setImageableArea(0, 0, format.getImageableWidth(), format.getImageableHeight());
  ...
  public static void main(String[] args) throws IOException, PrinterException {
    ...
    job.setPageable(new PageableText(new File("C:\\Users\\ALL\\Documents\\paedeiasERP\\inventario\\completoImpresion.txt"), format));
