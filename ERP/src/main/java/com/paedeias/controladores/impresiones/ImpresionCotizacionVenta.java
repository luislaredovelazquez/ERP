 ...
 * @author ALL
 */
public class ImpresionCotizacionVenta implements Printable{
    ...
    public ImpresionCotizacionVenta()
    {}
      ...
      if (pageIndex == 0) 
      {
       ...
       public String generarCadenaImpresion()
       {
        ...
        for (int o=0; o<partidas.size(); o++)
         ...
         cadenaImpresion = cadenaImpresion +                 "\n";         
         cadenaImpresion = cadenaImpresion +                 partidas.get(o).getCodigoArticulo();
         cadenaImpresion = cadenaImpresion +                 "\n";
         }
         ...
         cadenaImpresion = cadenaImpresion +                 "***********************************";
         cadenaImpresion = cadenaImpresion +                 "\n";
         cadenaImpresion = cadenaImpresion +                 "No. de articulos cotizados = "+totalArt;
         cadenaImpresion = cadenaImpresion +                 "\n";
         if(vendedor.length()<15)
         cadenaImpresion = cadenaImpresion +                 "Atendido por "+vendedor;
         else
         cadenaImpresion = cadenaImpresion +                 "Atendido por "+vendedor.substring(0,14);
         cadenaImpresion = cadenaImpresion +                 "\n";
         ...
         cadenaImpresion = cadenaImpresion +                 "===============================";
         cadenaImpresion = cadenaImpresion +                 "\n";
         cadenaImpresion = cadenaImpresion +                 "El precio en esta cotización se encuentra";
         cadenaImpresion = cadenaImpresion +                 "\n";
         cadenaImpresion = cadenaImpresion +                 "sujeto a cambios sin previo aviso.";
         cadenaImpresion = cadenaImpresion +                 "\n";
         cadenaImpresion = cadenaImpresion +                 "===============================";
         cadenaImpresion = cadenaImpresion +                 "\n";
         cadenaImpresion = cadenaImpresion +                 "************ GRACIAS **************";
