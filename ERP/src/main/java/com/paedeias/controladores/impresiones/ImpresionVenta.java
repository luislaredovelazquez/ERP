 ...
 * @author ALL
 */
public class ImpresionVenta implements Printable{
    ...
    {}
        ...
        public void inicializar(String noVenta,String cliente, 
            String totalArt, String vendedor, String fecha,List<Partidas> partidas)
    {
       ...
       /* font = new Font(Font.DIALOG, Font.PLAIN,7);   
       Map<TextAttribute, Object> attributes = new HashMap<TextAttribute, Object>();
       attributes.put(TextAttribute.TRACKING, 0.3);
       Font font2 = font.deriveFont(attributes);
       graphics.setFont(font2); */ //Impresora de San Mateo
      ...
      if (pageIndex == 0) 
      {
         ...
         renglon += 16;
         graphics.drawString("VENTA NO. -- "+noVenta+" --", margen,renglon); //+16
         renglon += 16;
       ...
       public String generarCadenaImpresion()
       {
         ...
         cadenaImpresion = cadenaImpresion +                 "VENTA NO. -- "+noVenta+" --";
         cadenaImpresion = cadenaImpresion +                 "\n";
         cadenaImpresion = cadenaImpresion +                 "***********************************";
         cadenaImpresion = cadenaImpresion +                 "\n";
         if(cliente.length()<26)
