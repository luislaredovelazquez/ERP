...
public class CFDv22 {
   ...
   /* String dia = JOptionPane.showInputDialog("Dia");
    ...
    String min = JOptionPane.showInputDialog("Minutos");
    String seg = JOptionPane.showInputDialog("Segundos"); */
    
  //  Date date = new GregorianCalendar(2012, 8, Integer.parseInt(dia), Integer.parseInt(horas), Integer.parseInt(min), Integer.parseInt(seg)).getTime();
    ...
    comp.setMetodoDePago(formapago.toLowerCase());
    comp.setLugarExpedicion(eelocalidad);
    if(formapago.toLowerCase().equals("transferencia")
     ||formapago.toLowerCase().equals("tarjeta de crédito")
     ||formapago.toLowerCase().equals("tarjeta de débito")||
       formapago.toLowerCase().equals("cheque"))
    comp.setNumCtaPago(numCtaPago); 
   // AddendaQualitas aq = new AddendaQualitas();
   // comp.setAddenda(aq.createAddenda(of));
    return comp;
    }
   ...
   // comp.setAddenda(aq.createAddenda(of));
    ...
    rf.setRegimen("Régimen General de Ley");
