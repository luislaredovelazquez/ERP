 ...
 * @author ALL
 */
public class VDetalle_VentasAnticipos extends javax.swing.JPanel {

    /**
     * Creates new form VDetalle_Ventas
     */
    public VDetalle_VentasAnticipos(Ventaanticipos venta) {
        initComponents();
        inicializar(venta);
    }
    ...
    private void initComponents() {
        ...
        jLabel36.setText("Anticipo:");

        jLabel37.setText("000000");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(jTable1.getSelectedRow() == -1)
        ...
        if (jTable1.getSelectedRow()!=-1&&listaPartidas.get(jTable1.getSelectedRow()).getCantidad() == Integer.parseInt(jTextField1.getText()))
        {
            ...
            ventadevuelta.setArticulos(ventadevuelta.getArticulos()+listaPartidas.get(jTable1.getSelectedRow()).getCantidad());
            ventadevuelta.setEstado("Devuelta");
            ventadevuelta.setPartidas(ventadevuelta.getPartidas()+1);
            ventadevuelta.setSubtotal(ventadevuelta.getSubtotal()+ listaPartidas.get(jTable1.getSelectedRow()).getCantidad() * listaPartidas.get(jTable1.getSelectedRow()).getConBeneficio());
            ventadevuelta.setTipoDeVenta(venta.getTipoDeVenta());
            ventadevuelta.setTotal(ventadevuelta.getTotal()+ listaPartidas.get(jTable1.getSelectedRow()).getCantidad() * listaPartidas.get(jTable1.getSelectedRow()).getConBeneficio());
        ...
        }else
        {
           int cantidad = listaPartidas.get(jTable1.getSelectedRow()).getCantidad() - Integer.parseInt(jTextField1.getText());
            ...
            dtm.setValueAt(cantidad, jTable1.getSelectedRow(), 2);
            dtm.setValueAt(listaPartidas.get(jTable1.getSelectedRow()).getSubtotal(), jTable1.getSelectedRow(), 8);
            jTable1.setModel(dtm);
        }   
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(!CConfiguracion.isDevolverVentasAnticipos())
        {
        jButton1.setEnabled(false);
        jButton8.setEnabled(false);
        jButton9.setEnabled(false);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       ...
       List<Ventaanticipos> nuevaVenta = hventas.consultaVentas("id", "=", String.valueOf(venta.getId()));
       ...
       transaccion = conexionweb.iniciarTransaccion() + " ";
        ...
        this.ventadevuelta.setCodigoVenta(venta.getTipoDeVenta()+venta.getId());
        ...
        //insertar devoluciones y guardar el kardex
           ...
           almacendevoluciones.setTipoBeneficio(listaDevoluciones.get(a).getTipoBeneficio());   
             ...
             partida.setDescripcionArticulo(listaDevoluciones.get(a).getDescripcionArticulo());
             partida.setCodigoArticulo(listaDevoluciones.get(a).getCodigoArticulo());
             partida.setCantidad(listaDevoluciones.get(a).getCantidad());
             partida.setConBeneficio(listaDevoluciones.get(a).getConBeneficio());
             partida.setSubtotal(listaDevoluciones.get(a).getSubtotal());
             listaImpresion.add(partida);   
         ...
         //       &&Double.compare(carticulo.get(0).getPrecioVenta(), almacendevoluciones.getPrecioVenta())==0
           ...
           //        System.out.println("almacen " +almacendevoluciones.getPrecioVenta() + "listaActualizar "+ listaActualizar.get(indiceConocer).getPrecioVenta());
            ...
            kardex.setRefFerrari("Anti"+venta.getTipoDeVenta().substring(1, 2) +this.venta.getId());  
            ...
            kardex.setResponsable2(CConfiguracion.getNombres()+" "+CConfiguracion.getApellidoP()+" "+CConfiguracion.getApellidoM());
            kardex.setVendidoEn(listaDevoluciones.get(a).getPrecioVenta());
        ...
        icaa.inicializar(String.valueOf(venta.getId()), jTextField2.getText(), "0", 
                                       confirmaalmacenista.getAdministrador(), hcc.generarFecha(), 
                                       confirmaalmacenista.getAlmacenista(),listaImpresion,"DEVOLUCIÓN");
       ...
       PageFormat format = new PageFormat();
        ...
        job.setPageable(new PageableText(icaa.generarCadenaImpresion(), format));
         ...
         job.print();
                ...
                Logger.getLogger(VDetalle_VentasAnticipos.class.getName()).log(Level.SEVERE, null, ex);
            } catch (PrinterException ex) {
            Logger.getLogger(ImpresionVenta.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        anticipos = hanticipos.consultaAnticipos("id", "=", String.valueOf(venta.getAnticipo()));
        anticipos.get(0).setDevuelta(1);
        hanticipos.actualizarAnticipos(anticipos.get(0), "id", "=", String.valueOf(anticipos.get(0).getId()));    
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       ...
       transaccion = conexionweb.iniciarTransaccion() + " ";
        ...
        icaa.inicializar(String.valueOf(venta.getId()), jTextField2.getText(), "0", 
                                       confirmaalmacenista.getAdministrador(), hcc.generarFecha(), 
                                       confirmaalmacenista.getAlmacenista(),listaImpresion,"CANCELACIÓN");
         PrinterJob job = PrinterJob.getPrinterJob();
         // job.setPrintable(icaa);
        // PageFormat format = job.pageDialog(job.defaultPage());
    ...
    //  this.venta = cancelar;
      ...
      for(Object o: listaPartidas){
             Partidasventaanticipos ipartidas = (Partidasventaanticipos)o;
       ...
       if(validar)
       {
           ...
           return;
            ...
            transaccion = conexionweb.iniciarTransaccion() + " ";
                ...
                ventadevuelta.setCodigoVenta(venta.getTipoDeVenta()+venta.getId());
             ...
             Partidas partida = new Partidas();
             partida.setDescripcionArticulo(listaPartidasVentas.get(i).getDescripcionArticulo());
             partida.setCodigoArticulo(listaPartidasVentas.get(i).getCodigoArticulo());
             partida.setCantidad(listaPartidasVentas.get(i).getCantidad());
             partida.setConBeneficio(listaPartidasVentas.get(i).getConBeneficio());
             listaImpresion.add(partida);  
           ...
           //       carticulo.get(0).getPrecioVenta()==almacendevoluciones.getPrecioVenta()) //si el precio de lo que se va a devolver son iguales a los que hay en el almacen principal
            ...
            kardex.setResponsable2(CConfiguracion.getNombres()+" "+CConfiguracion.getApellidoP()+" "+CConfiguracion.getApellidoM());
            kardex.setVendidoEn(listaPartidasVentas.get(i).getPrecioVenta());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        List<Partidas> lpartida= new ArrayList<Partidas>();
        for(int i=0; i<listaPartidas.size(); i++)
        {
            Partidas opartida = new Partidas();
            opartida.setBeneficio(listaPartidas.get(i).getBeneficio());
            opartida.setCantidad(listaPartidas.get(i).getCantidad());
            opartida.setCodigoArticulo(listaPartidas.get(i).getCodigoArticulo());
            opartida.setConBeneficio(listaPartidas.get(i).getConBeneficio());
            opartida.setDescripcionArticulo(listaPartidas.get(i).getDescripcionArticulo());
            opartida.setId(listaPartidas.get(i).getId());
            opartida.setIdArticulo(listaPartidas.get(i).getIdArticulo());
            opartida.setIdCompleto(listaPartidas.get(i).getIdCompleto());
            opartida.setIdVenta(listaPartidas.get(i).getIdVenta());
            opartida.setPrecioCompra(listaPartidas.get(i).getPrecioCompra());
            opartida.setPrecioVenta(listaPartidas.get(i).getPrecioVenta());
            opartida.setSubtotal(listaPartidas.get(i).getSubtotal());
            opartida.setTipoBeneficio(listaPartidas.get(i).getTipoBeneficio());
            opartida.setUbicacion(listaPartidas.get(i).getUbicacion());
            lpartida.add(opartida);
        }
        
        
        itv.inicializar(jLabel2.getText(),jLabel30.getText(),
                                               jLabel4.getText(),jLabel21.getText(), fecha.generarFecha().substring(0, 19), lpartida,
                                               jLabel12.getText(), jLabel8.getText(),
                                               jLabel10.getText(),df.format(iva));
        PrinterJob job = PrinterJob.getPrinterJob();
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        if(venta.getTipoDeVenta().equals("aUsado"))
        ...
        {
            iva = venta.getTotal() * CGlobalConfig.getIvaVenta();
            subtotal = venta.getTotal();
            total = subtotal + iva;
        ...
        Factura revision = hfacturas.consultaUltimaFactura("idConceptoFactura", "=", "VA"+venta.getId());
        if(revision != null && revision.getFolio() != null)
        {
            int eleccion = JOptionPane.showConfirmDialog(null, "Esta venta ya ha sido facturada, por favor revise "+"VA"+venta.getId()+" en el catálogo de facturas \n"
                                                + "¿Desea proseguir?");
        ...
        ventafactura.setIdConceptoFactura("VA"+venta.getId());
        ventafactura.setTotalLetra(numeroaletra.Convertir(df.format(venta.getTotal()), true));
        ventafactura.setIdReceptorF(venta.getIdcliente().intValue());
        ventafactura.setMotivo(jTextField2.getText());
        ventafactura.setMovimiento("Anticipo "+venta.getTipoDeVenta().substring(1));
        ventafactura.setNumMovimiento(String.valueOf(venta.getVale()));
        
        
        anticipos = hanticipos.consultaAnticipos("id", "=", String.valueOf(venta.getAnticipo()));
        if(anticipos.isEmpty())
        ventafactura.setAnticipoP("ANTP");
        else
        ventafactura.setAnticipoP("ANTP"+anticipos.get(0).getReferencia());
        
        VDetalle_FacturaCFDIAnticipo factura = new VDetalle_FacturaCFDIAnticipo(ventafactura,jLabel12.getText());
    ...
    hUsuarios husuarios;
    hClientes hclientes;
    hPartidaVentaAnticipos hpartidas;
    hAlmacendevoluciones halmacendevoluciones;
    hVentaAnticipos hventas;
    ...
    Vector vector;
    List<Partidasventaanticipos>  listaPartidas,listaPartidasVentas,listaBorrar;
    List<Partidasdevoluciones> listaDevoluciones;
    Vector<String> encabezadoPartidas;
    Ventaanticipos devolucion,venta,cancelar;
    Devoluciones ventadevuelta;
    Almacendevoluciones almacendevoluciones;
    hKardex hkardex;
    DecimalFormat df;
    List<Anticipos> anticipos;
    hAnticipos hanticipos;
    double comprobarCancelacion = 0.0;
    
    private void inicializar(Ventaanticipos venta) {
      ...
      jLabel16.setText(venta.getObservaciones());
      jLabel34.setText(venta.getEstado());
      jLabel37.setText(String.valueOf(venta.getAnticipo()));
      ...
      devolucion = new Ventaanticipos();
      this.venta = new Ventaanticipos();
      cancelar = new Ventaanticipos();
     // devolucion = venta;
     // this.venta = venta;
      ...
      this.venta.setAnticipo(venta.getAnticipo());
     ...
     ladministrador = husuarios.consultaUsuarios("id", "=", String.valueOf(venta.getIdadministrador()));
      ...
      hpartidas = new hPartidaVentaAnticipos ();
      listaPartidas = new ArrayList<Partidasventaanticipos>();
      listaBorrar = new ArrayList<Partidasventaanticipos>();
      listaPartidas = hpartidas.consultaPartidas("idVenta", "=", String.valueOf(venta.getId()));
      ...
      encabezadoPartidas.add("Con Beneficio");
      ...
      for(Object o: listaPartidas){
          ...
          hventas = new hVentaAnticipos();
          hpartidasdevoluciones = new hPartidasDevoluciones();
          ventadevuelta = new Devoluciones();
          
            ventadevuelta.setArticulos(0);
            ventadevuelta.setPartidas(0);
            ventadevuelta.setSubtotal(Double.valueOf("0"));
            ventadevuelta.setTotal(Double.valueOf("0"));
            ventadevuelta.setIdVenta(venta.getId());
