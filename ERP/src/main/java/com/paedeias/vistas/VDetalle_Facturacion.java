 ...
 * @author ALL
 */
public class VDetalle_Facturacion extends javax.swing.JPanel {
    ...
    public VDetalle_Facturacion(Factura factura) {
        initComponents();
    ...
    private void inicializar(Factura fact)
    {
         ...
         hpartidasfacturas = new hPartidasfacturas();
    ...
    private void initComponents() {
        ...
        jPanel21Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                ...
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTextField50, javax.swing.GroupLayout.DEFAULT_SIZE, 508, Short.MAX_VALUE)
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CFD 2.2", "CFD 2.0" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        VDetalle_Facturacion.PSeleccionar_Cliente seleccionar = new VDetalle_Facturacion.PSeleccionar_Cliente();
...
/*           Factura factemporal=hfacturas.consultaUltimaFactura("idConceptoFactura", "=", this.factura.getIdConceptoFactura());
    ...
    /*    CFactura facturaCFD = new CFactura();
        ...
        facturaCFD.setVersion(jComboBox1.getSelectedItem().toString().substring(4));
   ...
   /*     CFactura facturaCFD = new CFactura();
        ...
        ReporteFactura reportefactura = new ReporteFactura();
        if(jComboBox2.getSelectedItem().toString().toLowerCase().equals("efectivo"))
        reportefactura.crearReporte(Long.valueOf(jTextField44.getText()),jTextField50.getText(),jTextField51.getText(),"","",1);     
        else
        reportefactura.crearReporte(Long.valueOf(jTextField44.getText()),jTextField50.getText(),jTextField51.getText(),jTextField11.getText(),jTextField10.getText(),1);                        
        }    
        
       try {
            Desktop.getDesktop().open(new File("pdfs/factura"+jTextField44.getText()+".pdf"));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        facturaCFD.setFolio(jTextField44.getText());
        facturaCFD.setFormapago(jComboBox2.getSelectedItem().toString());
        facturaCFD.setImporte(jTextField47.getText());               //////
        facturaCFD.setImptraslados(jTextField47.getText());
        facturaCFD.setNoaprobacion(jTextField43.getText());
        facturaCFD.setRcalle(jTextField28.getText());
        facturaCFD.setRcolonia(jTextField30.getText());
        facturaCFD.setRcp(jTextField31.getText());
        ...
        facturaCFD.setRrfc(jTextField19.getText());
        facturaCFD.setRciudad(jTextField32.getText());
        facturaCFD.setSubtotal(jTextField45.getText());
        facturaCFD.setTipoDeComprobante(jTextField40.getText());
        facturaCFD.setTotal(jTextField48.getText());
        facturaCFD.setUecalle(jTextField3.getText());
        facturaCFD.setUecolonia(jTextField5.getText());
        facturaCFD.setUecp(jTextField6.getText());
        facturaCFD.setUeestado(jTextField8.getText());
        ...
        facturaCFD.setRegimenfiscal(jTextField42.getText());
        facturaCFD.setNumCtaPago(jTextField10.getText());
        facturaCFD.setVersion("2.2");
//        facturaCFD.Sellar(partidas); 
        ...
        hfacturas.actualizarFactura(facbd, "folio", "=", facbd.getFolio());
    ...
    private hPartidasfacturas hpartidasfacturas;
