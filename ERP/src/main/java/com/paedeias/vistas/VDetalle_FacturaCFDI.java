 ...
 * @author ALL
 */
public class VDetalle_FacturaCFDI extends javax.swing.JPanel {
    ...
    public VDetalle_FacturaCFDI(Factura factura, String tipo) {
        initComponents();
     ...
     public VDetalle_FacturaCFDI(Factura factura, String tipo, String reservacion) {
        initComponents();
        this.factura = factura;
        this.tipo = tipo;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        VDetalle_FacturaCFDI.PSeleccionar_Cliente seleccionar = new VDetalle_FacturaCFDI.PSeleccionar_Cliente();
     ...
     vector = new Vector();
      ...
      tablaCliente.addMouseListener(new MouseListener()
      {
        ...
        double total = 0;
         ...
         if(tipo.equals("venta")||tipo.equals("reservacion"))
         {
            if(listaCliente.get(indice).getId() == 1) //Público en general
        {
            iva = 0;
            subtotal = Double.valueOf(jTextField48.getText());
            total = Double.valueOf(jTextField48.getText());
