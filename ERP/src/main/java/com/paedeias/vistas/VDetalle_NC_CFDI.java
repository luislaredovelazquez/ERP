 ...
 * @author ALL
 */
public class VDetalle_NC_CFDI extends javax.swing.JPanel {


    /**
     * Creates new form VDetalle_Factura
     */
        public VDetalle_NC_CFDI(Factura factura, String tipo) {
        initComponents();
     ...
     public VDetalle_NC_CFDI(Factura factura, String tipo, String reservacion) {
        initComponents();
        this.factura = factura;
        this.tipo = tipo;
    ...
    private void inicializar()
    {
         ...
         if(tipo.equals("nc"))
         {
         partidas = hpartidas.consultaPartidasPartida("idVenta", "=", String.valueOf(factura.getIdConceptoFactura().substring(2)));
         if(cliente.getNombre().equalsIgnoreCase("Público en general"))
        {
            iva = 0;
        ...
        jTextField40.setText(CGlobalConfig.getNotaCredito_tipoComprobante()); 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        VDetalle_NC_CFDI.PSeleccionar_Cliente seleccionar = new VDetalle_NC_CFDI.PSeleccionar_Cliente();
...
public boolean ValidaRfc(String rfcStr) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     //   facbd.setIdFactura(Long.valueOf(jTextField44.getText()));
        ...
        //facbd.setFolio(jTextField44.getText()); //
        //facbd.setFolio("0"); 
        facbd.setFolioInterno(jTextField41.getText());
        ...
        try {
            File xmlSAT = new File("xmls/fac"+folio+"nccfdi.xml");
            FileOutputStream fos3 = new FileOutputStream(xmlSAT);
            fos3.write(facturaCFD.getRespuestaPAC());
            fos3.flush();
            fos3.close();
        } catch (IOException ex) {
            Logger.getLogger(VDetalle_FacturaCFDI.class.getName()).log(Level.SEVERE, null, ex);
        } 
   
          org.jdom.input.SAXBuilder builder=new org.jdom.input.SAXBuilder(false);
          org.jdom.Document doc = builder.build("xmls/fac"+folio+"nccfdi.xml");
        ...
        if(tipo.equals("nc"))
         {
        hDevoluciones hdev = new hDevoluciones();
        
        if(!CGlobalConfig.isWeb())
        hdev.cambiarAFacturada(String.valueOf(jTextField41.getText().substring(2)));
        else
        transaccion = transaccion + hdev.crearQueryCambiarAFacturada(String.valueOf(jTextField41.getText().substring(2))) + " ";    
        
        VDetalle_Devolucion.jButton4.setEnabled(false);
        }
       ...
       // hfacturas.actualizarFactura(facbd, "idFactura", "=", jTextField44.getText());
        ...
        reportefactura.crearReporte((long)folio,jTextField50.getText(),jTextField51.getText(),"","",1,cadenaQR);     
        else
        reportefactura.crearReporte((long)folio,jTextField50.getText(),jTextField51.getText(),jTextField11.getText(),jTextField10.getText(),1,cadenaQR); 
        }else
        {
        ...
        reportefactura.fill(cadenaQR,1,folio);    
        }    
        
        if(!CGlobalConfig.isWeb())
        {
        facturaCFD.generarRespaldo("xmls/fac"+folio+"nccfdi.xml", "\\\\192.168.1.90\\Reports\\xmls\\fac"+folio+"nccfdi.xml");
        facturaCFD.generarRespaldo("pdfs/factura"+folio+"cfdi.pdf", "\\\\192.168.1.90\\Reports\\pdfs\\factura"+folio+"cfdi.pdf");
        }
        ...
        try {
            ...
            Logger.getLogger(VDetalle_NC.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private hPartidasDevoluciones hpartidas;
