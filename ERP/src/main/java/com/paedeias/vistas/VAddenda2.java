...
public class VAddenda2 extends JPanel {
    ...
    String c_emisor_noExterior="306";
    ...
    String c_noAprobacion="1712296";
    String c_anoAprobacion="2011"; 	
    ...
    public VAddenda2()
    {
        ...
        GridLayout marco = new GridLayout(12,2);
  ...
  //  add(campoTexto12);
    ...
    public void actionPerformed(ActionEvent evento){
       ...
       {
           JOptionPane.showMessageDialog(VAddenda2.this,"No ha seleccionado ningún xml");
           return;
       }
       if(campoTexto2.getText().isEmpty())       {
           JOptionPane.showMessageDialog(VAddenda2.this,"El campo de número de póliza está vacio"); return; }
       if(campoTexto3.getText().isEmpty())       {
           JOptionPane.showMessageDialog(VAddenda2.this,"El campo de INC está vacio"); return;}
       if(campoTexto4.getText().isEmpty())       {
           JOptionPane.showMessageDialog(VAddenda2.this,"El campo de tipo de cliente está vacio"); return;}
       if(campoTexto5.getText().isEmpty())       {
           JOptionPane.showMessageDialog(VAddenda2.this,"El campo de número de reporte está vacio"); return;}
       if(campoTexto6.getText().isEmpty())       {
           JOptionPane.showMessageDialog(VAddenda2.this,"El campo de número de siniestro está vacio"); return;}
       if(campoTexto7.getText().isEmpty())       {
           JOptionPane.showMessageDialog(VAddenda2.this,"El campo  de tipo de vehículo está vacio"); return;}
       if(campoTexto8.getText().isEmpty())       {
           JOptionPane.showMessageDialog(VAddenda2.this,"El campo  de marca está vacio"); return;}
       if(campoTexto9.getText().isEmpty())       {
           JOptionPane.showMessageDialog(VAddenda2.this,"El campo  de modelo está vacio"); return;}
       if(campoTexto10.getText().isEmpty())       {
           JOptionPane.showMessageDialog(VAddenda2.this,"El campo  de año está vacio"); return;}
        if(campoTexto11.getText().isEmpty())       {
           JOptionPane.showMessageDialog(VAddenda2.this,"El campo  de folio está vacio"); return;}
    ...
    public org.jdom.Element leerXML(String direccion)
    {
        try{
          ...
          this.c_folio=raiz.getAttributeValue("folio");
          this.c_fecha=raiz.getAttributeValue("fecha");
          this.c_noAprobacion=raiz.getAttributeValue("noAprobacion");
          this.c_anoAprobacion=raiz.getAttributeValue("anoAprobacion");
       ...
       /*     c_receptor_nombre="QUALITAS COMPAÑIA DE SEGUROS S.A.B.  DE C.V.";
            c_receptor_rfc="QCS931209G49";
            c_receptor_calle="JOSE MARIA CASTORENA";
            c_receptor_codigoPostal="05200";
            c_receptor_colonia="SAN JOSE DE LOS CEDROS";
            c_receptor_estado="DISTRITO FEDERAL";
            c_receptor_localidad="CUAJIMALPA";
            c_receptor_municipio="CUAJIMALPA";
            c_receptor_noExterior="426";
            c_receptor_nrointerior="0";
            c_receptor_pais="MÉXICO"; */
          
           this.c_receptor_nombre = raiz.getChild("Receptor",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getAttributeValue("nombre");
          this.c_receptor_rfc=raiz.getChild("Receptor",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getAttributeValue("rfc");
          this.c_receptor_calle=raiz.getChild("Receptor",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getChild("Domicilio",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getAttributeValue("calle");
          this.c_receptor_colonia=raiz.getChild("Receptor",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getChild("Domicilio",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getAttributeValue("colonia");
          this.c_receptor_estado=raiz.getChild("Receptor",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getChild("Domicilio",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getAttributeValue("estado");
          // this.c_receptor_municipio=raiz.getChild("Receptor",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getChild("Domicilio",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getAttributeValue("municipio"); 
          // this.c_receptor_municipio="CUAJIMALPA";
          this.c_receptor_noExterior=raiz.getChild("Receptor",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getChild("Domicilio",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getAttributeValue("noExterior");
         //  this.c_receptor_nrointerior="0";
          this.c_receptor_pais=raiz.getChild("Receptor",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getChild("Domicilio",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getAttributeValue("pais"); 
          this.c_receptor_codigoPostal=raiz.getChild("Receptor",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getChild("Domicilio",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getAttributeValue("codigoPostal"); 
          // this.c_receptor_localidad=raiz.getChild("Receptor",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getChild("Domicilio",Namespace.getNamespace("http://www.sat.gob.mx/cfd/2")).getAttributeValue("localidad"); 
      ...
      /*    Iterator i = listaConceptos;
         ...
         return raiz;
            ...
            Logger.getLogger(VAddenda2.class.getName()).log(Level.SEVERE, null, ex);
                    return null;
...
comprobante.setAttribute("xsi:schemaLocation", "http://www.sat.gob.mx/cfd/2 http://www.sat.gob.mx/sitio_internet/cfd/2/cfdv22.xsd");
comprobante.setAttribute("version", "2.2");
...
comprobante.setAttribute("noAprobacion", c_noAprobacion);
comprobante.setAttribute("anoAprobacion", c_anoAprobacion);
...
regimenFiscal.setAttribute("Regimen", "Régimen General de Ley");
...
Element addenda = document.createElement("Addenda");
...
Text tnroAprob = document.createTextNode(c_noAprobacion);
nroAprob.appendChild(tnroAprob);
Element anoAprob = document.createElement("AnoAprob");  
Text tanoAprob = document.createTextNode(c_anoAprobacion);
...
Text tcontEmisorTipo = document.createTextNode("matriz");
Text tcontEmisorNombre = document.createTextNode("Hortencia Vilchis");
Text tcontEmisorEmail = document.createTextNode("comsatoluca@hotmail.com");
Text tcontEmisorTelefono = document.createTextNode("(722)2191666");
...
Double montoTotal = Double.parseDouble(valorUnita) * Integer.parseInt(cantidadFormateada);
