 ...
 * @author ALL
 */
public class VDetalle_NC extends javax.swing.JPanel {


    /**
     * Creates new form VDetalle_Factura
     */
        public VDetalle_NC(Factura factura, String tipo) {
        initComponents();
     ...
     public VDetalle_NC(Factura factura, String tipo, String reservacion) {
        initComponents();
        this.factura = factura;
        this.tipo = tipo;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        VDetalle_NC.PSeleccionar_Cliente seleccionar = new VDetalle_NC.PSeleccionar_Cliente();
...
try{
     ...
     //   facbd.setIdFactura(Long.valueOf(jTextField44.getText()));
       ...
       // hfacturas.actualizarFactura(facbd, "idFactura", "=", jTextField44.getText());
        ...
        reportefactura.crearReporte((long)folio,jTextField50.getText(),jTextField51.getText(),"","",1);     
        else
        reportefactura.crearReporte((long)folio,jTextField50.getText(),jTextField51.getText(),jTextField11.getText(),jTextField10.getText(),1); 
