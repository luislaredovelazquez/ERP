 ...
 * @author ALL
 */
public class hPartidasfacturasCFDI {

    public hPartidasfacturasCFDI(){}
        ...
        public List<Partidasfacturas> consultaPartidas(String campo, String match, String condicion)
    {
     ...
     //           conexion.crearConexion();
        ...
        if(CGlobalConfig.isWeb())  
       {
        ...
        String query = "";
        if(match.equals("*")){
            query = "SELECT id,codigoArticulo,cantidad,precioUnitario,importe,descripcion,idVenta,idFactura FROM partidasfacturascfdi;";
            }
            else if(match.equals("="))
            {
            query = "SELECT id,codigoArticulo,cantidad,precioUnitario,importe,descripcion,idVenta,idFactura FROM partidasfacturascfdi WHERE "+campo+" "+match+" \'"+condicion+"\';";
            }else
            {
            query = "SELECT id,codigoArticulo,cantidad,precioUnitario,importe,descripcion,idVenta,idFactura FROM partidasfacturascfdi WHERE "+campo+" "+match+" \'%"+condicion+"%\';";
            }
        ...
        try{
          ...
          //Escribe el .php
          URL url=new URL("http://www.quimerasystems.com/paehelp/paePartidasfacturasCFDI.php");
       ...
       try {
            ...
            if(match.equals("*")){
            conjuntoResultados = CPrincipal.getConexion().crearConsulta("SELECT id,codigoArticulo,cantidad,precioUnitario,importe,descripcion,idVenta,idFactura FROM partidasfacturascfdi;");
            }
            else if(match.equals("="))
            {
            conjuntoResultados = CPrincipal.getConexion().crearConsulta("SELECT id,codigoArticulo,cantidad,precioUnitario,importe,descripcion,idVenta,idFactura FROM partidasfacturascfdi WHERE "+campo+" "+match+" \'"+condicion+"\';");
            }else
            {
            conjuntoResultados = CPrincipal.getConexion().crearConsulta("SELECT id,codigoArticulo,cantidad,precioUnitario,importe,descripcion,idVenta,idFactura FROM partidasfacturascfdi WHERE "+campo+" "+match+" \'%"+condicion+"%\';");
            }
   ...
   /*    public int consultaArticulos(String factura)
          ...
          public int guardarPartidas(Partidasfacturas a)
    {
           int filas_afectadas=0;
            String query = "INSERT INTO partidasfacturascfdi (codigoArticulo," + 
    ...
    public String crearQueryGuardarPartidas(Partidasfacturas a)
    {
           
            String query = "INSERT INTO partidasfacturascfdi (codigoArticulo," + 
                    "cantidad,precioUnitario,importe,descripcion,idVenta,idFactura" +
                    ") VALUES" + "(\'" + a.getCodigoArticulo() + "\',\'" + a.getCantidad() + "\',\'" + a.getPrecioUnitario() + "\',\'" + a.getImporte() 
                    + "\',\'" +a.getDescripcion() + "\',\'" +a.getIdVenta() + "\',@ultimo_id);";
    ...
    public int borrarPartidas(String campo, String match, String condicion)
    {
     ...
     if(match.equals("="))
            {
     query = "DELETE  FROM partidasfacturascfdi WHERE "+campo+" "+match+" \'"+condicion+"\';";
     ...
     return tipo_respuesta;
        ...
        if(match.equals("="))
            {
            CPrincipal.getConexion().moverDatos("DELETE  FROM partidasfacturascfdi WHERE "+campo+" "+match+" \'"+condicion+"\';");
            }else  if(match.equals("LIKE"))
            {
            CPrincipal.getConexion().moverDatos("DELETE  FROM partidasfacturascfdi WHERE "+campo+" "+match+" \'%"+condicion+"%\';");
            }
   ...
   //           conexion.crearConexion();
     ...
     String query = "UPDATE partidasfacturascfdi SET codigoArticulo = \'" +  a.getCodigoArticulo()+"\',"+
    ...
    {
     String query = "UPDATE partidasfacturascfdi SET codigoArticulo = \'"+codigoNuevo+"\' WHERE codigoArticulo = \'"+codigoViejo+"\';";
    ...
    {
       hPartidasfacturasCFDI ejemplo = new hPartidasfacturasCFDI();
       List<Partidasfacturas> articulos = ejemplo.consultaPartidas("id","=","1");
       int i = 0;
   ...
   //   System.out.println(ejemplo.borrarPartidas("id", "=", "2"));
       ...
       Partidasfacturas art = new Partidasfacturas();
                art.setCantidad(2);
