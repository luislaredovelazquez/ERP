 ...
 * @author ALL
 */
public class hPartidasDevoluciones {

    public hPartidasDevoluciones(){}
    
        public List<Partidasdevoluciones> consultaPartidas(String campo, String match, String condicion)
    {
       List<Partidasdevoluciones> articulos = new ArrayList<Partidasdevoluciones>();
     ...
     //           conexion.crearConexion();
        ...
        if(CGlobalConfig.isWeb())  
       {
		...
		//Escribe tu query	
           String query = "";
           if(match.equals("*")){
             query = "SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasdevoluciones;";
            }
            else if(match.equals("="))
            {
             query = "SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasdevoluciones WHERE "+campo+" "+match+" \'"+condicion+"\';";
            }else
            {
             query = "SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasdevoluciones WHERE "+campo+" "+match+" \'%"+condicion+"%\';";
            }
        ...
        try{
          ...
          //Escribe el .php
          URL url=new URL("http://www.quimerasystems.com/paehelp/paePartidasDevoluciones.php");
	   ...
	   for(int l=0; l<atributos.length; l++)
	    ...
	    Partidasdevoluciones articulo = new Partidasdevoluciones(
       ...
       try {
            ...
            if(match.equals("*")){
            conjuntoResultados = CPrincipal.getConexion().crearConsulta("SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasdevoluciones;");
            }
            else if(match.equals("="))
            {
            conjuntoResultados = CPrincipal.getConexion().crearConsulta("SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasdevoluciones WHERE "+campo+" "+match+" \'"+condicion+"\';");
            }else
            {
            conjuntoResultados = CPrincipal.getConexion().crearConsulta("SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasdevoluciones WHERE "+campo+" "+match+" \'%"+condicion+"%\';");
            }
        ...
        return null;
          ...
          public List<Partidas> consultaPartidasPartida(String campo, String match, String condicion)
    {
     ...
     //           conexion.crearConexion();
         if(CGlobalConfig.isWeb())  
       {
        ...
        datosEnv.put("metodo","consultaPartidasPartida()");
       ...
       try {
        ...
        return null;
          ...
          public int guardarPartidas(Partidasdevoluciones a)
    {
           int filas_afectadas=0;
            String query = "INSERT INTO partidasdevoluciones (idVenta," + 
    ...
    public String crearQueryGuardarPartidas(Partidasdevoluciones a)
    {
            String query = "INSERT INTO partidasdevoluciones (idVenta," + 
                    "idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio," +
    ...
    {
     String query = "UPDATE partidasdevoluciones SET codigoArticulo = \'"+codigoNuevo+"\' WHERE codigoArticulo = \'"+codigoViejo+"\';";
    ...
    public int borrarPartidas(String campo, String match, String condicion)
    {
     ...
     if(match.equals("="))
            {
     query = "DELETE  FROM partidasdevoluciones WHERE "+campo+" "+match+" \'"+condicion+"\';";
     ...
     return tipo_respuesta;
        ...
        if(match.equals("="))
            {
            CPrincipal.getConexion().moverDatos("DELETE  FROM partidasdevoluciones WHERE "+campo+" "+match+" \'"+condicion+"\';");
            }else  if(match.equals("LIKE"))
            {
            CPrincipal.getConexion().moverDatos("DELETE  FROM partidasdevoluciones WHERE "+campo+" "+match+" \'%"+condicion+"%\';");
            }
     ...
     public int actualizarPartidas(Partidasdevoluciones a,String campoCondicion,String match,String condicion)
    {
     int resultado = 0;
   //  Conexion conexion = new Conexion();
   //           conexion.crearConexion();
     ...
     String query = "UPDATE partidasdevoluciones SET idVenta = \'" +  a.getIdVenta()+"\',"+
    ...
    {
       hPartidasDevoluciones ejemplo = new hPartidasDevoluciones();
       List<Partidasdevoluciones> articulos = ejemplo.consultaPartidas("id","=","1");
       int i = 0;
   ...
   //   System.out.println(ejemplo.borrarPartidas("id", "=", "2"));
       ...
       Partidasdevoluciones art = new Partidasdevoluciones();
