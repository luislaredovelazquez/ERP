...
public class hFacturasCFDI {
    
        public hFacturasCFDI()
         {}
     ...
     //  conexion.crearConexion();
             if(CGlobalConfig.isWeb())  
       {
        ...
        try{
          ...
          //Escribe el .php
          URL url=new URL("http://www.quimerasystems.com/paehelp/paeFacturasCFDI.php");
	   ...
	   for(int l=0; l<atributos.length; l++)
		   ...
		   //Arma el objeto y agrega a la lista en su caso
	        ...
	        Factura factura = new Factura(); 
                ...
                factura.setCertificadoSAT(atributos[36]);
       ...
       try {
            ...
            while (conjuntoResultados.next()) {
                ...
                factura.setCertificadoSAT(conjuntoResultados.getObject(36).toString());
                facturas.add(factura);
            }
            return facturas;
     ...
     //  conexion.crearConexion();
               ...
               if(CGlobalConfig.isWeb())  
       {
		...
		//Escribe tu query	
            String query = "";
            if(match.equals("*")){
            query = "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi;";
            }
            else if(match.equals("="))
            {
            query = "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi;";
     ...
     //  conexion.crearConexion();
                ...
                if(CGlobalConfig.isWeb())  
       {
		...
		//Escribe tu query	
            ...
            if(match.equals("="))
            {
            query = "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi WHERE movimiento LIKE '%Venta%' AND numMovimiento "+match+" \'"+condicion+"\'  ORDER BY idFactura DESC LIMIT 100;";
            }else
            {
            query = "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi WHERE movimiento LIKE '%Venta%' AND numMovimiento "+match+" \'%"+condicion+"%\' ORDER BY idFactura DESC LIMIT 100;";
            }
      ...
      // conexion.crearConexion();
                    ...
                    if(CGlobalConfig.isWeb())  
       {
		...
		//Escribe tu query	
            ...
            if(match.equals("="))
            {
            query = "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi WHERE movimiento LIKE '%Reser%' AND numMovimiento "+match+" \'"+condicion+"\'  ORDER BY idFactura DESC LIMIT 100;";
            }else
            {
            query = "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi WHERE movimiento LIKE '%Reser%' AND numMovimiento "+match+" \'%"+condicion+"%\' ORDER BY idFactura DESC LIMIT 100;";
            }
        ...
        datosEnv.put("metodo","consultaFacturasReservacionCFDI()");
     ...
     //  conexion.crearConexion();
                     ...
                     if(CGlobalConfig.isWeb())  
       {
		...
		//Escribe tu query	
            ...
            if(match.equals("="))
            {
            query = "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi WHERE movimiento LIKE '%Usado%' AND numMovimiento "+match+" \'"+condicion+"\'  ORDER BY idFactura DESC LIMIT 100;";
            }else
            {
            query = "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi WHERE movimiento LIKE '%Usado%' AND numMovimiento "+match+" \'%"+condicion+"%\' ORDER BY idFactura DESC LIMIT 100;";
            }
      ...
      // conexion.crearConexion();
            ...
            if(CGlobalConfig.isWeb())  
       {
		...
		//Escribe tu query	
            ...
            if(match.equals("="))
            {
            query = "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi WHERE movimiento LIKE '%Nuevo%' AND numMovimiento "+match+" \'"+condicion+"\'  ORDER BY idFactura DESC LIMIT 100;";
            }else
            {
            query = "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi WHERE movimiento LIKE '%Nuevo%' AND numMovimiento "+match+" \'%"+condicion+"%\' ORDER BY idFactura DESC LIMIT 100;";
            }
     ...
     //  conexion.crearConexion();
                                      if(CGlobalConfig.isWeb())  
       {
		...
		//Escribe tu query	
            String query = "";
             ...
             query =  "SELECT idFactura,version,serie,folio,fecha,noAprobacion,anoAprobacion,formaDePago,subtotal,descuento,total,totalLetra,tipoDeComprobante,noCertificado,certificado,sello,idEmisorF,idReceptorF,idConceptoFactura,impuesto,tasa,importeImp,folioInterno,regimen,cadenaCompleta,motivo,fechaReporte,cantidadArticulos,movimiento,numMovimiento,cancelada,versionTimbre,uuid,fechaTimbrado,selloSAT,certificadoSAT FROM facturacfdi WHERE fechaReporte BETWEEN"+" \'"+fecha1+" 00:00:00\' AND \'"+fecha2+" 23:59:59\' AND cancelada = 0;";               
       ...
       try {
        ...
        return null;
            ...
            /*Permite consultar todos los datos, o algunos datos dependiendo de la condición*/
    public String consultaUltimoFolio()
    {
     ...
     //  conexion.crearConexion();
                                             if(CGlobalConfig.isWeb())  
       {
		...
		//Escribe tu query	
            String query = "";
             ...
             query =  "SELECT idFactura FROM facturacfdi ORDER BY idFactura DESC LIMIT 1;";               
        ...
        datosEnv.put("metodo","consultaUltimoFolio()");
       ...
       try {
            ResultSet conjuntoResultados;
            conjuntoResultados = CPrincipal.getConexion().crearConsulta("SELECT idFactura FROM facturacfdi ORDER BY idFactura DESC LIMIT 1;");

                       
            while (conjuntoResultados.next()) {
                
               ultimoFolio = conjuntoResultados.getObject(1).toString();
   ...
   //           conexion.crearConexion();
     ...
     String query = "UPDATE facturacfdi SET "+
    ...
    public Factura consultaUltimaFactura(String campo, String match, String condicion)
    {
     ...
     //  conexion.crearConexion();
       ...
       try {
            ...
            Logger.getLogger(hFacturasCFDI.class.getName()).log(Level.SEVERE, null, ex);
        } finally
        {
        CPrincipal.getConexion().cerrar(0);
        }
   ...
   //  Conexion conexion = new Conexion();
   //  conexion.crearConexion();
     String query = "UPDATE facturacfdi SET idReceptorF = \'" + clienteNuevo+"\' WHERE idReceptorF = \'" + clienteViejo +"\'";
       CPrincipal.getConexion().moverDatos(query);
       CPrincipal.getConexion().cerrar(1);
         ...
         public int guardarFactura(Factura a)
    {
            ...
            String query = " INSERT INTO facturacfdi (" 
                  + "idFactura,"  
                  + "version,"
                  + "serie,"
                  + "folio,"
     ...
     public String crearQueryGuardarFactura(Factura a)
    {
            java.util.Date utilDate = new java.util.Date();
            long milisec = utilDate.getTime();
            Timestamp time= new Timestamp(milisec);    
     ...
     public int borrarFactura(String campo, String match, String condicion)
    {
     ...
     if(match.equals("="))
            {
     query = "DELETE  FROM facturacfdi WHERE "+campo+" "+match+" \'"+condicion+"\';";
     ...
     return tipo_respuesta;
        ...
        if(match.equals("="))
            {
            CPrincipal.getConexion().moverDatos("DELETE  FROM facturacfdi WHERE "+campo+" "+match+" \'"+condicion+"\';");
            }else  if(match.equals("LIKE"))
            {
            CPrincipal.getConexion().moverDatos("DELETE  FROM facturacfdi WHERE "+campo+" "+match+" \'%"+condicion+"%\';");
            }
     ...
     public int actualizarUsuario(String campo, String UsuarioNuevo, String UsuarioViejo)
    {
     int resultado = 0;
       ...
       String query = "UPDATE facturacfdi SET "+ campo +" = \'"+UsuarioNuevo+"\' WHERE "+campo+ " = \'"+UsuarioViejo+"\';";
    ...
    //          conexion.crearConexion();
     ...
     String query = "UPDATE facturacfdi SET " +
                  ...
                  "certificadoSAT = \'" +     a.getCertificadoSAT()+"\',"+
                  "motivo = \'" +    a.getMotivo()+"\'";
    ...
    public String crearQueryActualizarFacturaCFDIDF(Factura a,String campoCondicion,String match,String condicion)
    {
   ...
   //           conexion.crearConexion();
    ...
    {
        hFacturasCFDI ejemplo = new hFacturasCFDI();
