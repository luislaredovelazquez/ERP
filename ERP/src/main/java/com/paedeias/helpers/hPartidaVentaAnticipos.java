 ...
 * @author ALL
 */
public class hPartidaVentaAnticipos {

    public hPartidaVentaAnticipos(){}
    
        public List<Partidasventaanticipos> consultaPartidas(String campo, String match, String condicion)
    {
       List<Partidasventaanticipos> articulos = new ArrayList<Partidasventaanticipos>();
    ...
    //            conexion.crearConexion();
        if(CGlobalConfig.isWeb())  
       {
        ...
        String query = "";
         if(match.equals("*")){
            query = "SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasventaanticipos;";
            }
            else if(match.equals("="))
            {
            query = "SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasventaanticipos WHERE "+campo+" "+match+" \'"+condicion+"\';";
            }else
            {
            query = "SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasventaanticipos WHERE "+campo+" "+match+" \'%"+condicion+"%\';";
            }
        ...
        try{
          ...
          //Escribe el .php
          URL url=new URL("http://www.quimerasystems.com/paehelp/paePartidaVentaAnticipos.php");
	   ...
	   for(int l=0; l<atributos.length; l++)
		   ...
		   //Arma el objeto y agrega a la lista en su caso
             ...
             Partidasventaanticipos articulo = new Partidasventaanticipos(
       ...
       try {
            ...
            if(match.equals("*")){
            conjuntoResultados = CPrincipal.getConexion().crearConsulta("SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasventaanticipos;");
            }
            else if(match.equals("="))
            {
            conjuntoResultados = CPrincipal.getConexion().crearConsulta("SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasventaanticipos WHERE "+campo+" "+match+" \'"+condicion+"\';");
            }else
            {
            conjuntoResultados = CPrincipal.getConexion().crearConsulta("SELECT id,idVenta,idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio,cantidad,subtotal FROM partidasventaanticipos WHERE "+campo+" "+match+" \'%"+condicion+"%\';");
            }
        ...
        return null;
          ...
          public int guardarPartidas(Partidasventaanticipos a)
    {
           int filas_afectadas=0;
            String query = "INSERT INTO partidasventaanticipos (idVenta," + 
    ...
    public String crearQueryGuardarPartidas(Partidasventaanticipos a)
    {
            String query = "INSERT INTO partidasventaanticipos (idVenta," + 
                    "idArticulo,codigoArticulo,descripcionArticulo,precioCompra,precioVenta,tipoBeneficio,beneficio,conBeneficio," +
    ...
    //            conexion.crearConexion();
     ...
     if(match.equals("="))
            {
     query = "DELETE  FROM partidasventaanticipos WHERE "+campo+" "+match+" \'"+condicion+"\';";
     ...
     return tipo_respuesta;
        ...
        if(match.equals("="))
            {
            CPrincipal.getConexion().moverDatos("DELETE  FROM partidasventaanticipos WHERE "+campo+" "+match+" \'"+condicion+"\';");
            }else  if(match.equals("LIKE"))
            {
            CPrincipal.getConexion().moverDatos("DELETE  FROM partidasventaanticipos WHERE "+campo+" "+match+" \'%"+condicion+"%\';");
            }
     ...
     public String crearQueryBorrarPartidas(String campo, String match, String condicion)
    {
     ...
     public int actualizarPartidas(Partidasventaanticipos a,String campoCondicion,String match,String condicion)
    {
     int resultado = 0;
    // Conexion conexion = new Conexion();
    //          conexion.crearConexion();
     ...
     String query = "UPDATE partidasventaanticipos SET idVenta = \'" +  a.getIdVenta()+"\',"+
     ...
     return resultado;
       ...
       public String crearQueryActualizarPartidas(Partidasventaanticipos a,String campoCondicion,String match,String condicion)
    {
    ...
    {
     String query = "UPDATE partidasventaanticipos SET codigoArticulo = \'"+codigoNuevo+"\' WHERE codigoArticulo = \'"+codigoViejo+"\';";
    ...
    {
       hPartidaVentaAnticipos ejemplo = new hPartidaVentaAnticipos();
       List<Partidasventaanticipos> articulos = ejemplo.consultaPartidas("id","=","1");
       int i = 0;
   ...
   //   System.out.println(ejemplo.borrarPartidas("id", "=", "2"));
       ...
       Partidasventaanticipos art = new Partidasventaanticipos();
